...
function get_catmull_rom_curve(list_of_3d_vectors: THREE.Vector3[], is_cycle: boolean, smoothness_value: number) {
...
export function get_transform_matrix(position: THREE.Vector3, lookat: THREE.Vector3, up: THREE.Vector3) {
