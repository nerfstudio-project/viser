var Module = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    var wasmBinaryFile;
    if (Module["locateFile"]) {
      wasmBinaryFile = "Sorter.wasm";
      if (!isDataURI(wasmBinaryFile)) {
        wasmBinaryFile = locateFile(wasmBinaryFile);
      }
    } else {
      wasmBinaryFile = new URL("Sorter.wasm", import.meta.url).href;
    }
    ...
    var wasmImports = {
      ...
      l: __emval_as,
      j: __emval_call_void_method,
      b: __emval_decref,
      v: __emval_get_method_caller,
    ...
    var ___cxa_is_pointer_type = (a0) =>
      (___cxa_is_pointer_type = wasmExports["F"])(a0);
